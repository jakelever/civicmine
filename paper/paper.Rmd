...
biomarkerComparisonPlot.withTitle <- arrangeGrob(biomarkerComparisonPlot,top='(a)')
pmidComparisonPlot.withTitle <- arrangeGrob(pmidComparisonPlot,top='(b)')
cgiPredictivePlot.withTitle <- arrangeGrob(cgiPredictivePlot,top='(c)')
cgiPredisposingPlot.withTitle <- arrangeGrob(cgiPredisposingPlot,top='(d)')
oncoKBPredictivePlot.withTitle <- arrangeGrob(oncoKBPredictivePlot,top='(e)')

comparisonPlot <- arrangeGrob(biomarkerComparisonPlot,
            pmidComparisonPlot,
            cgiPredictivePlot,
            cgiPredisposingPlot,
            oncoKBPredictivePlot,
            ncol=2)
